...
namespace NanaManagerAPI.UI
{
    public static class UI
    {
        ...
        public static void SetStatus( string Status ) => StatusChanged( Status, -1, null );
        /// <summary>
        ...
        public static void SetStatus( string Status, double Progress, double Maximum ) => StatusChanged( Status, Progress, Maximum );
        /// <summary>
        /// Sets the application into fullscreen if true
        /// </summary>
        /// <param name="Value">Whether to use Fullscreen or Windowed</param>
        public static void SetFullscreen( bool Value ) => Fullscreen( Value );
